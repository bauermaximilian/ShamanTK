...
namespace Eterra.Platforms.Windows.Graphics
{
    ...
    internal class Graphics : DisposableBase, IGraphics
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="Eterra.Graphics.Size"/> of the 
        ...
        public void Render<CanvasT>(RenderParameters parameters, 
            ...
            Eterra.Graphics.RenderTextureBuffer renderTarget = null)
        ...
        /// exceeded platform-specific limits.
        /// </exception>
        public Eterra.Graphics.TextureBuffer CreateTextureBuffer(Size size, 
        ...
        /// exceeded platform-specific limits.
        /// </exception>
        public Eterra.Graphics.RenderTextureBuffer CreateRenderBuffer(
