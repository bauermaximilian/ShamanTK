...
namespace Eterra.IO
{
    ...
    /// <see cref="EterraApplicationBase"/> finished redrawing itself. After 
    ...
    public class ResourceManager : IDisposable
    {
        ...
        /// a resource loading/buffering task in a <see cref="EterraApp"/> 
        /// without blocking update or drawing operations.
        /// </summary>
        ...
        /// <see cref="EterraApp"/>, continiously initiates a state-check in
        /// the current <see cref="SyncTask{T}"/>. If the asynchronous 
